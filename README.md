...
A demo showcasing container components in Qt Quick. Includes examples for Pane, Frame, GroupBox, custom GroupBox styling, ScrollView, and nested container composition.
